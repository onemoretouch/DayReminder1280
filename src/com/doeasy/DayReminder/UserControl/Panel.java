...
public class Panel extends LinearLayout {
	...
	private Drawable mOpeningHandle;
	private Drawable mClosedHandle;
	private Drawable mClosingHandle;
	...
	public Panel(Context context, AttributeSet attrs) {
		...
		mOpeningHandle = a.getDrawable(R.styleable.Panel_openingHandle);
		mClosingHandle = a.getDrawable(R.styleable.Panel_closingHandle);
	...
	public void setOpen(boolean open, boolean animate) {
		if (isOpen() ^ open) {
			...
			if (animate) {
				...
				mHandle.setBackgroundDrawable(open?mOpeningHandle:mClosingHandle);
				post(startAnimation);
			} else {
...
//			Log.d(TAG, "state: " + mState + " x: " + event.getX() + " y: " + event.getY());
			...
			if (action == MotionEvent.ACTION_DOWN) {
				...
				if (mContent.getVisibility() == GONE) {
					...
					mHandle.setBackgroundDrawable(mOpeningHandle);
				}
				else
				{
					mHandle.setBackgroundDrawable(mClosingHandle);
				}
